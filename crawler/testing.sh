...
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/index.html $output_dir 0

echo "Running Test 2: Valid seed URL, depth 1"
# Test with valid seed URL and depth of 1 for basic crawl
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/index.html $output_dir 1

echo "Running Test 3: Valid seed URL, maximum depth 10"
# Test with valid seed URL at maximum depth limit (10) for deep crawl
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/index.html $output_dir 10
...
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/index.html nonexistent_dir 1
...
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/index.html $output_dir five
...
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/nonexistent.html $output_dir 1
...
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/circular_link.html $output_dir 2
...
./crawler http://cs50tse.cs.dartmouth.edu/tse/letters/sample.pdf $output_dir 1
