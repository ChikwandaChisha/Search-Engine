...
To build `libengine.a`, run `make`. 

The starter kit includes a pre-built library, `libengine-given.a`, in case you prefer to use our Lab3 solutions rather than your own.
